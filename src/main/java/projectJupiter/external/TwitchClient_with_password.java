...
public class TwitchClient_with_password {
    private static final String TOKEN = "Bearer prjyqiyakldfg8w4m6bckz0dtd5emz";
    private static final String CLIENT_ID = "s80p67m68bdu38ggvtrafu620ah8lb";
